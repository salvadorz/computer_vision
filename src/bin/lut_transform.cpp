...
/// @brief Helper Function to apply a transform function tu be used by the LUT
/// @tparam Callable is the handle to any callable functions, functors with a call-operator
/// @param mat_tf array to store the function implementation received by
/// @param f function
template<typename Callable>
void transform_function (cv::Mat& mat_tf,Callable f)
{
